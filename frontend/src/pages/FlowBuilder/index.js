          ...
          <>
            {webhooks.map(contact => (
              ...
              >
                ...
                <Grid item xs={4} align="center" style={{ color: "#444394" }}  onClick={() => history.push(`/flowbuilder/${contact.id}`)}>
                ...
                <Grid item xs={4} align="end">
                  ...
                  >
                    <ContentCopy style={{ color: "#444394" }} />
                  </IconButton>
                  <IconButton
                    size="small"
                  ...
                  >
                    <Stack sx={{ width: 24 }}>
                      <Build sx={{ width: 20, color: "#444394" }} />
                    </Stack>
                  </IconButton>
                  <Can
                    role={user.profile}
                    ...
                    yes={() => (
                      ...
                      >
                        <DeleteOutlineIcon style={{ color: "#444394" }} />
                      </IconButton>
                    )}
                  /> */}
                </Grid>
